...
@Repository
public class IpConfigJdbcRepositoryImpl implements IpConfigJdbcRepository {

	@Autowired
	JdbcTemplate jdbcTemplate;
	
	/* (non-Javadoc)
	 * @see com.chikelueoji.mtahostingoptimizer.repository.IpConfigJdbcRepository#findInefficientHosts(java.lang.String)
	 */
	@Override
